...
class BasicDataset(object):
    ...
    def _get_bg(self,idx):
        raise NotImplementedError("You must overwrite _get_bg(self,idx),and return a pic")

    def _get_fg(self,idx):
        raise NotImplementedError("You must overwrite _get_fg(self),and return a pic and it mask")
